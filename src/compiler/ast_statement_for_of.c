...
neo_serialize_ast_statement_for_of(neo_allocator_t allocator,
  ...
  neo_any_set(
      variable, "type",
      neo_create_any_string(allocator, "NEO_NODE_TYPE_STATEMENT_FOR_OF"));
...
neo_create_ast_statement_for_of(neo_allocator_t allocator) {
  neo_ast_statement_for_of_t node =
      neo_allocator_alloc(allocator, sizeof(struct _neo_ast_statement_for_of_t),
                          neo_ast_statement_for_of_dispose);
