...
static void
neo_ast_expression_function_write(neo_allocator_t allocator,
...
neo_serialize_ast_expression_function(neo_allocator_t allocator,
  ...
  neo_variable_set(variable, L"type",
                   neo_create_variable_string(
                       allocator, L"NEO_NODE_TYPE_EXPRESSION_FUNCTION"));
  ...
  neo_variable_set(variable, L"async",
  ...
  neo_variable_set(variable, L"generator",
...
neo_create_ast_expression_function(neo_allocator_t allocator, const char *file,
  ...
  node->node.write = (neo_write_fn_t)neo_ast_expression_function_write;
  node->async = false;
