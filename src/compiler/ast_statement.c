#include "compiler/ast_declaration_class.h"
#include "compiler/ast_declaration_export.h"
#include "compiler/ast_declaration_function.h"
#include "compiler/ast_declaration_import.h"
