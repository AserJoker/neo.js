#include "neojs/compiler/ast_class_accessor.h"
#include "neojs/compiler/asm.h"
#include "neojs/compiler/ast_decorator.h"
#include "neojs/compiler/ast_function_argument.h"
#include "neojs/compiler/ast_function_body.h"
#include "neojs/compiler/ast_node.h"
#include "neojs/compiler/ast_object_accessor.h"
#include "neojs/compiler/ast_object_key.h"
#include "neojs/compiler/ast_private_name.h"
...
neo_ast_node_t neo_ast_read_class_accessor(neo_allocator_t allocator,
  ...
  for (;;) {
    ...
    if (decorator->type == NEO_NODE_TYPE_ERROR) {
      error = decorator;
      decorator = NULL;
      goto onerror;
    }
