...
neo_js_uninitialized_t neo_create_js_uninitialized(neo_allocator_t allocator) {
  neo_js_uninitialized_t uninitialized = neo_allocator_alloc(
      allocator, sizeof(struct _neo_js_uninitialized_t), neo_js_uninitialized_dispose);
  neo_init_js_uninitialized(uninitialized, allocator);
  return uninitialized;
}

void neo_init_js_uninitialized(neo_js_uninitialized_t self, neo_allocator_t allocaotr) {
