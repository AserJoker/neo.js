...
neo_js_variable_t neo_js_generator_next(neo_js_context_t ctx,
  ...
  if (co_ctx->result) {
    ...
    if (neo_js_variable_get_type(value)->kind == NEO_JS_TYPE_INTERRUPT) {
      ...
      neo_js_chunk_add_parent(co_ctx->result, neo_js_variable_get_chunk(self));
...
void neo_js_context_init_std_generator(neo_js_context_t ctx) {
  ...
  neo_js_context_def_field(
      ...
      neo_js_context_create_cfunction(ctx, "next", neo_js_generator_next), true,
      false, true);

  neo_js_context_def_field(
      ctx, prototype, neo_js_context_create_string(ctx, "return"),
      neo_js_context_create_cfunction(ctx, "return", neo_js_generator_return),
      true, false, true);

  neo_js_context_def_field(
      ctx, prototype, neo_js_context_create_string(ctx, "throw"),
      neo_js_context_create_cfunction(ctx, "throw", neo_js_generator_throw),
      true, false, true);
}