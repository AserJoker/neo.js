...
NEO_JS_CFUNCTION(neo_js_date_constructor) {
  ...
  neo_time_t *utc =
      neo_allocator_alloc(allocator, sizeof(struct _neo_time_t), NULL);
  neo_js_context_set_opaque(ctx, self, "#time", time);
  neo_js_context_set_opaque(ctx, self, "#utc", utc);

  for (uint32_t idx = 0; idx < argc; idx++) {
    if (neo_js_variable_get_type(argv[idx])->kind == NEO_JS_TYPE_OBJECT) {
      neo_time_t *time = neo_js_context_get_opaque(ctx, argv[idx], "#time");
      if (time) {
        continue;
      }
    }
  ...
  if (!argc) {
    ...
    *utc = neo_clock_resolve(neo_clock_get_timestamp(), 0);
    ...
    if (neo_js_variable_get_type(argv[0])->kind == NEO_JS_TYPE_OBJECT) {
      *time = *(neo_time_t *)neo_js_context_get_opaque(ctx, argv[0], "#time");
      *utc = *(neo_time_t *)neo_js_context_get_opaque(ctx, argv[0], "#utc");
...
NEO_JS_CFUNCTION(neo_js_date_get_date) {
  neo_time_t *tm = neo_js_context_get_opaque(ctx, self, "#time");
  if (!tm) {
...
NEO_JS_CFUNCTION(neo_js_date_get_utc_date) {
  neo_time_t *tm = neo_js_context_get_opaque(ctx, self, "#utc");
  if (!tm) {
    return neo_js_context_create_simple_error(ctx, NEO_JS_ERROR_TYPE, 0,
                                              "this is not a Date object.");
  }
...
NEO_JS_CFUNCTION(neo_js_date_set_date) {
  ...
  neo_time_t *utc = neo_js_context_get_opaque(ctx, self, "#utc");
  if (!utc) {
    return neo_js_context_create_simple_error(ctx, NEO_JS_ERROR_TYPE, 0,
                                              "this is not a Date object.");
  }
...
void neo_js_context_init_std_date(neo_js_context_t ctx) {
  neo_js_context_def_field(
      ...
      neo_js_context_create_string(ctx, "now"),
      neo_js_context_create_cfunction(ctx, "now", neo_js_date_now), true, false,
      true);

  neo_js_variable_t parse =
      neo_js_context_create_cfunction(ctx, "parse", neo_js_date_parse);
  neo_js_context_def_field(ctx, neo_js_context_get_std(ctx).date_constructor,
                           neo_js_context_create_string(ctx, "parse"), parse,
                           true, false, true);

  neo_js_variable_t utc =
      neo_js_context_create_cfunction(ctx, "UTC", neo_js_date_utc);
  neo_js_context_def_field(ctx, neo_js_context_get_std(ctx).date_constructor,
  ...
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getDate"),
                           get_date, true, false, true);

  neo_js_variable_t get_day =
      neo_js_context_create_cfunction(ctx, "getDay", neo_js_date_get_day);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getDay"), get_day,
                           true, false, true);

  neo_js_variable_t get_full_year = neo_js_context_create_cfunction(
      ctx, "getFullYear", neo_js_date_get_full_year);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getFullYear"),
                           get_full_year, true, false, true);

  neo_js_variable_t get_hours =
      neo_js_context_create_cfunction(ctx, "getHours", neo_js_date_get_hours);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getHours"),
                           get_hours, true, false, true);

  neo_js_variable_t get_milliseconds = neo_js_context_create_cfunction(
      ctx, "getMilliseconds", neo_js_date_get_milliseconds);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getMilliseconds"),
                           get_milliseconds, true, false, true);

  neo_js_variable_t get_minutes = neo_js_context_create_cfunction(
      ctx, "getMinutes", neo_js_date_get_minutes);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getMinutes"),
                           get_minutes, true, false, true);

  neo_js_variable_t get_month =
      neo_js_context_create_cfunction(ctx, "getMonth", neo_js_date_get_month);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getMonth"),
                           get_month, true, false, true);

  neo_js_variable_t get_seconds = neo_js_context_create_cfunction(
      ctx, "getSeconds", neo_js_date_get_seconds);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getSeconds"),
                           get_seconds, true, false, true);

  neo_js_variable_t get_time =
      neo_js_context_create_cfunction(ctx, "getTime", neo_js_date_get_time);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getTime"),
                           get_time, true, false, true);

  neo_js_variable_t get_timezone_offset = neo_js_context_create_cfunction(
      ctx, "getTimezoneOffset", neo_js_date_get_timezone_offset);
  neo_js_context_def_field(
      ctx, prototype, neo_js_context_create_string(ctx, "getTimezoneOffset"),
      get_timezone_offset, true, false, true);

  neo_js_variable_t get_utc_date = neo_js_context_create_cfunction(
      ctx, "getUTCDate", neo_js_date_get_utc_date);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCDate"),
                           get_utc_date, true, false, true);

  neo_js_variable_t get_utc_day = neo_js_context_create_cfunction(
      ctx, "getUTCDay", neo_js_date_get_utc_day);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCDay"),
                           get_utc_day, true, false, true);

  neo_js_variable_t get_utc_full_year = neo_js_context_create_cfunction(
      ctx, "getUTCFullYear", neo_js_date_get_utc_full_year);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCFullYear"),
                           get_utc_full_year, true, false, true);

  neo_js_variable_t get_utc_hours = neo_js_context_create_cfunction(
      ctx, "getUTCHours", neo_js_date_get_utc_hours);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCHours"),
                           get_utc_hours, true, false, true);

  neo_js_variable_t get_utc_milliseconds = neo_js_context_create_cfunction(
      ctx, "getUTCMilliseconds", neo_js_date_get_utc_milliseconds);
  neo_js_context_def_field(
      ctx, prototype, neo_js_context_create_string(ctx, "getUTCMilliseconds"),
      get_utc_milliseconds, true, false, true);

  neo_js_variable_t get_utc_minutes = neo_js_context_create_cfunction(
      ctx, "getUTCMinutes", neo_js_date_get_utc_minutes);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCMinutes"),
                           get_utc_minutes, true, false, true);

  neo_js_variable_t get_utc_month = neo_js_context_create_cfunction(
      ctx, "getUTCMonth", neo_js_date_get_utc_month);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCMonth"),
                           get_utc_month, true, false, true);

  neo_js_variable_t get_utc_seconds = neo_js_context_create_cfunction(
      ctx, "getUTCSeconds", neo_js_date_get_utc_seconds);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "getUTCSeconds"),
                           get_utc_seconds, true, false, true);

  neo_js_variable_t set_date =
      neo_js_context_create_cfunction(ctx, "setDate", neo_js_date_set_date);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setDate"),
                           set_date, true, false, true);

  neo_js_variable_t set_full_year = neo_js_context_create_cfunction(
      ctx, "setFullYear", neo_js_date_set_full_year);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setFullYear"),
                           set_full_year, true, false, true);

  neo_js_variable_t set_utc_date = neo_js_context_create_cfunction(
      ctx, "setUTCDate", neo_js_date_set_utc_date);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setUTCDate"),
                           set_utc_date, true, false, true);

  neo_js_variable_t set_utc_full_year = neo_js_context_create_cfunction(
      ctx, "setUTCFullYear", neo_js_date_set_utc_full_year);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setUTCFullYear"),
                           set_utc_full_year, true, false, true);

  neo_js_variable_t set_utc_hours = neo_js_context_create_cfunction(
      ctx, "setUTCHours", neo_js_date_set_utc_hours);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setUTCHours"),
                           set_utc_hours, true, false, true);

  neo_js_variable_t set_utc_milliseconds = neo_js_context_create_cfunction(
      ctx, "setUTCMilliseconds", neo_js_date_set_utc_milliseconds);
  neo_js_context_def_field(
      ctx, prototype, neo_js_context_create_string(ctx, "setUTCMilliseconds"),
      set_utc_milliseconds, true, false, true);

  neo_js_variable_t set_utc_minutes = neo_js_context_create_cfunction(
      ctx, "setUTCMinutes", neo_js_date_set_utc_minutes);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setUTCMinutes"),
                           set_utc_minutes, true, false, true);

  neo_js_variable_t set_utc_month = neo_js_context_create_cfunction(
      ctx, "setUTCMonth", neo_js_date_set_utc_month);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setUTCMonth"),
                           set_utc_month, true, false, true);

  neo_js_variable_t set_utc_seconds = neo_js_context_create_cfunction(
      ctx, "setUTCSeconds", neo_js_date_set_utc_seconds);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setUTCSeconds"),
                           set_utc_seconds, true, false, true);

  neo_js_variable_t set_year =
      neo_js_context_create_cfunction(ctx, "setYear", neo_js_date_set_year);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "setYear"),
                           set_year, true, false, true);

  neo_js_variable_t to_time_string = neo_js_context_create_cfunction(
      ctx, "toTimeString", neo_js_date_to_time_string);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "toTimeString"),
                           to_time_string, true, false, true);

  neo_js_variable_t to_string =
      neo_js_context_create_cfunction(ctx, "toString", neo_js_date_to_string);
  neo_js_context_def_field(ctx, prototype,
  ...
  neo_js_variable_t to_date_string = neo_js_context_create_cfunction(
      ctx, "toDateString", neo_js_date_to_date_string);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "toDateString"),
                           to_date_string, true, false, true);

  neo_js_variable_t to_iso_string = neo_js_context_create_cfunction(
      ctx, "toISOString", neo_js_date_to_iso_string);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "toISOString"),
                           to_iso_string, true, false, true);

  neo_js_variable_t to_utc_string = neo_js_context_create_cfunction(
      ctx, "toUTCString", neo_js_date_to_utc_string);
  neo_js_context_def_field(ctx, prototype,
                           neo_js_context_create_string(ctx, "toUTCString"),
                           to_utc_string, true, false, true);

  neo_js_variable_t value_of =
      neo_js_context_create_cfunction(ctx, "valueOf", neo_js_date_value_of);
  neo_js_context_def_field(ctx, prototype,
