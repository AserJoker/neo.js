...
neo_js_type_t neo_get_js_number_type() {
  static struct _neo_js_type_t type = {
      neo_js_number_typeof,       neo_js_number_to_string,
      neo_js_number_to_boolean,   neo_js_number_to_number,
      neo_js_number_to_primitive, neo_js_number_to_object,
      neo_js_number_get_field,    neo_js_number_set_field,
      neo_js_number_del_field,    neo_js_number_is_equal,
  };
  return &type;
}
